...
class Attention(nn.Module):
    ...
    def window_partition(self, x, h_window_size, w_window_size):
        ...
        windows = x.permute(0, 1, 3, 2, 4, 5).reshape(-1, h_window_size, w_window_size, C) # widow_num
        return windows
...
class FusionModel(BaseFeaturesExtractor):
    ...
    def forward(self, observations):
        ...
        all_feature_output = self.output(all_feature_output.reshape(batch_size, -1)) # B N H (1,176,32)
